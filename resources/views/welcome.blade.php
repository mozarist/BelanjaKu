<x-app-layout>
    ...
    {{-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-gradient-to-t from-zinc-950 to-zinc-900 w-full p-4 border border-zinc-800 aspect-square rounded-2xl text-white">
        ...
        <div class="bg-gradient-to-t from-zinc-950 to-zinc-900 w-full p-4 border border-zinc-800 aspect-square lg:aspect-auto rounded-2xl text-white lg:col-span-2">
            <h6 class="text-4xl font-semibold">Perabotan Rumah</h6>
        </div>
    ...
    <h3 class="text-6xl text-center font-semibold">Rekomendasi Produk</h3>
