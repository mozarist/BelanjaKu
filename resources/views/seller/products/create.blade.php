        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <label for="status_barang" class="block ">
                ...
                <select name="status"
                    ...
                    <option value="nonaktif" class="bg-zinc-950 text-white">Nonaktif</option>
                </select>
            </label>
            ...
            <div class="flex items-center justify-end gap-3 pt-2">
                ...
                <button type="submit"
                    class="px-8 py-2 rounded-md bg-gradient-to-tr from-indigo-600 to-rose-600 text-white text-sm hover:brightness-110">
                    Kirim
                </button>
            </div>
        </form>
